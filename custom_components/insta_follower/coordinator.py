...
class InstaDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching data from the API."""

    config_entry: IntegrationInstaConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        try:
            return await self.config_entry.runtime_data.client.async_get_followers()
